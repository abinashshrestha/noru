...
?>
    <style type="text/css">
        .page-banner {
            background: #333 url(<?php echo get_template_directory_uri() . '/images/Noru-Banner-2.jpg' ?>) bottom right no-repeat;
        }
    </style>
        ...
        <div class="container my-7">
            <div class="row d-flex flex-column-reverse flex-md-row">
                <div class="col-12 col-md-7">
                    <h2 class="title title--left title--border">Live Better</h2>
                ...
                <div class="col-12 col-md-5 text-center">
                    <img src="<?php echo get_template_directory_uri() . '/images/Noru_Logo-favicon.png' ?>"
                         class="company-logo" alt="Noru Pharma">
                </div>
            </div>
            <div class="row mt-7">
                <div class="col-12 col-md-4 text-muted py-4">
                    <div class="mb-5 bg-success" style="width:70px; height: 70px;"></div>
                    <h3 class="title title--left title--border">Innovation</h3>
                    <p class="mt-4">We believe in researching and developing innovative products within our focus
                                    categories so you
                ...
                <div class="col-12 col-md-4 text-muted py-4">
                    ...
                    <p class="mt-4">Noru Pharma currently operates in the UK, Hong Kong, Singapore, Australia and New
                                    Zealand.</p>
                ...
                <div class="col-12 col-md-4 text-muted py-4">
                    <div class="mb-5 bg-success" style="width:70px; height: 70px;"></div>
                    <h3 class="title title--left title--border">Innovation</h3>
                    <p class="mt-4">We work with leading pharmacy chains to ensure that availability of our products to
                                    you at an affordable price. </p>
